...
def function0(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [0,0,0]
    return [0,0,0]

def function1(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [0,1,0]
    return [0,0,0]

def function2(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [1,0,0]
    return [0,0,0]

def function3(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [1,1,0]
    return [0,0,0]

def function4(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [0,-1,0]
    return [0,0,0]

def function5(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [-1,0,0]
    return [0,0,0]

def function6(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [-1,-1,0]
    return [0,0,0]

def function7(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [1,-1,0]
    return [0,0,0]

def function8(inputValue):
    activate = activationThreshold(inputValue)
    if activate : return [-1,1,0]
    return [0,0,0]


def function9(inputValue, facing):     #Move Forward
    activate = activationThreshold(inputValue)
    moveTo = [0, 0, 0]
    ...
    if activate : return moveTo
    return [0,0,0]

def function10(inputValue, facing):    #Move Backward
    activate = activationThreshold(inputValue)
    moveTo = [0, 0, 0]
    if facing == 0  : moveTo[0] = -1
    elif facing == 1: moveTo[1] = -1
...
def function11(inputValue, facing):    #Turn counterClockwise
    activate = activationThreshold(inputValue)
    if activate : return [0,0,1]
    return [0,0,0]

def function12(inputValue, facing):    #Turn Clockwise
    activate = activationThreshold(inputValue)
    if activate : return [0,0,-1]
    return [0,0,0]

def functionKill(inputValue, killing):
    activate = activationThreshold(inputValue)
    if killing: 
        if random.random() > .9: return activate
    return False
