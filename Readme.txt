...
Open and run 530_final.ipynb to start the main simulation. Detailed instructions for setting parameters are provided within the notebook.
Refer to initializationVariables.ipynb for initial settings and configurations.
For detailed exploration or modification of specific components, you can refer to the corresponding notebooks listed above.
